  ...
  return (
    <>
      ...
      <div className="button-control">
        ...
        {!contract && !loading && <div>Start the process, of creating a contract on the blockchain, by confirming the transaction that is initiated when you press the button below.</div>}
